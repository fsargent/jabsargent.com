...
<svelte:head>
	<title>Resume — Jennifer Bronstein Sargent</title>
</svelte:head>

<div class="resume-document prose prose-invert mx-auto max-w-4xl">
	<h1 class="font-heading tracking-wide uppercase">Jennifer Bronstein Sargent</h1>

	<div class="not-prose print-hidden mb-6">
		<ResumeSwitcher current="resume" />
	</div>
	...
	<h2 id="freelance-2023">
		Video Content Consultant/Video Director @ Freelance <span class="text-neutral-400">| 2023</span>
	</h2>
	<p>
	...
	<ul>
		...
		<li>
			Associate Producer/French Fixer, <em>Blood, Sweat and Gears: Racing Clean to the Tour
			de France</em> @ Sundance Channel (2008)
		</li>
