...
<p>
	...
	communication. My background is in production, but the work has always been project management
	and operational execution.
</p>
<p>
	Based in London and experienced across the US and UK, I'm actively moving out of media and into
	an industry-agnostic project management role (PMO / operations / delivery) where calm,
...
<ul>
	...
	<li>Project reporting: status updates, decision logs, action items, and delivery readiness.</li>
	<li>Process improvement: establish simple workflows that reduce churn and keep teams focused.</li>
	<li>Vendor and partner management: sourcing, onboarding, timelines, and delivery QA.</li>
	<li>Team leadership style: direct and calm; I look for clarity before speed.</li>
</ul>
...
<ul>
	...
	<li>
		Director, <em>Steel Birds</em>, based on Chekhov's Three Sisters @ EstroGenius Theatre Festival
		(2016)
	</li>
...
<ul>
	...
	<li>
		Tribeca Film Festival - Spotlight Documentary (2017) — <em>The Year of the Scab</em>, ESPN 30 for
		30
	</li>
	<li>
