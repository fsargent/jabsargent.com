...
<ul>
	<li>
		Target roles: PMO Analyst, Project Coordinator, Junior Project Manager, Digital Project
		Manager, Implementation Project Manager
	</li>
	<li>
		Target industries: finance/insurance, healthcare, public sector, utilities/energy,
...
<h2>
	Executive Producer (Project Lead) @ Parable (London)
...
<h2>
	Executive Producer (Delivery Lead) @ Omnicom Studios (SF)
	<span class="text-neutral-400">| 2024 - 2025</span>
</h2>
<p>
...
<ul>
	<li>
		Own schedules, budget tracking, and delivery coordination across internal teams and
		vendors.
	</li>
...
<ul>
	...
	<li>
		Manage delivery across account teams and client contacts; keep approvals and handoffs
		tight.
	</li>
...
<p class="text-sm text-neutral-400">
	<strong>Clients:</strong> eBay, Scholastic, PayPal, Eli Lilly, Dolby, Microsoft, Taco Bell
	&amp; TB Foundation, Adobe, DuPont, Starbucks, Gordon &amp; Betty Moore Foundation, Wu Tsai
	Human Performance Alliance, Sacramento Department of Behavioral Health, Hologic, Gold Bond,
	Getaround, AbbVie, Genentech, Jazz Pharmaceuticals, Allegra
</p>
...
<p class="text-sm text-neutral-400">
	...
	Secret Wedding (TLC), Monsters Inside Me (Animal Planet), Deadly Ambition (Biography),
	Comedy Central Presents:15 (Comedy Central), Car Hunters (History Channel), Island Life
	(HGTV), Beat Bobby Flay (Food Network), The Singles Project (Bravo), Find My First Love
...
<p class="text-sm text-neutral-400">
	...
	Most Wanted, America's Supernanny, 24 Hour Catwalk
</p>
...
<ul>
	...
	<li>
		Director, <em>Steel Birds</em>, based on Chekhov's Three Sisters @ EstroGenius Theatre
		Festival (2016)
	</li>
	<li>
		Festival Producer, Rendez-Vous with French Cinema at Lincoln Center @ UniFrance USA
		(2008-2010)
	</li>
	<li>
...
<ul>
	...
	<li>
		Tribeca Film Festival - Spotlight Documentary (2017) — <em>The Year of the Scab</em>,
		ESPN 30 for 30
	</li>
	<li>
	...
	<li>
		Emmy Award Outstanding Creative Achievement in Interactive Media Multiplatform
		Storytelling (2015) — <em>The Singles Project</em>, Bravo
	</li>
</ul>
